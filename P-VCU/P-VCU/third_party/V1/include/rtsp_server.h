...
int rtsp_open(int ch, RtspServerAttr *rtsp_attr);
void rtsp_close(int ch);
void rtsp_start(int ch);
void rtsp_stop(int ch);
void rtsp_sendData(int ch, RtspSendDataParam *param);
