...
int mp4_storage_save_frame(unsigned char *p_buf);
int mp4_storage_save_mp4(unsigned char *p_gop_buf, unsigned int gop_size);
int mp4_storage_mp4_init(unsigned int fd, int max_during_sec, unsigned int video_codec_type,unsigned int audio_codec_type);
