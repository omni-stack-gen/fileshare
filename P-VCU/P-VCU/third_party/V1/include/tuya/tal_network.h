...
extern const TUYA_IP_ADDR_T     ty_ip_addr_any;
extern const TUYA_IP_ADDR_T     ty_ip_addr_broadcast;
extern const TUYA_IP_ADDR_T     ty_ip_addr_loopback;
extern const TUYA_IP_ADDR_T     ty_ip6_addr_any;
