...
typedef enum __ISP_CFG_BIN_MODE
{
	...
	LINEAR_AIISP_CFG = 2, // linear aiisp config
	WDR_COLOR_CFG = 3, // wdr day config
	WDR_IR_CFG = 4, // wdr ir config
}ISP_CFG_BIN_MODE;
...
ERRORTYPE AW_MPI_ISP_Init_AE_SetMode(ISP_DEV IspDev, int mode);         // [0:auto, 1:manual]
ERRORTYPE AW_MPI_ISP_Init_AE_SetExposureBias(ISP_DEV IspDev, int Value);    // [1, 8]
ERRORTYPE AW_MPI_ISP_Init_AE_SetExposure(ISP_DEV IspDev, int Value);        // [0, 65535*16]
ERRORTYPE AW_MPI_ISP_Init_AE_SetGain(ISP_DEV IspDev, int Value);            // [0, 65535]
ERRORTYPE AW_MPI_ISP_Init_AE_SetISOSensitive(ISP_DEV IspDev, int Value); // [0~7]->[auto,100,200,400,800,1600,3200,6400]
ERRORTYPE AW_MPI_ISP_Init_AE_SetMetering(ISP_DEV IspDev, int Value); // [0:average,1:center,2:spot,3:matrix]
ERRORTYPE AW_MPI_ISP_Init_AWB_SetMode(ISP_DEV IspDev, int Value);       // [0:auto, 1:manual, 2-9]
ERRORTYPE AW_MPI_ISP_Init_AWB_SetGain(ISP_DEV IspDev, struct isp_wb_gain *pIspWbGain);      // [256, 256 * 64]
ERRORTYPE AW_MPI_ISP_Init_SetFlicker(ISP_DEV IspDev, int Value);                // [0:disable,1:50,2:60,3:auto]
ERRORTYPE AW_MPI_ISP_Init_SetBrightness(ISP_DEV IspDev, int Value);         //[0, 512]
ERRORTYPE AW_MPI_ISP_Init_SetContrast(ISP_DEV IspDev, int Value);            // [0, 512]
ERRORTYPE AW_MPI_ISP_Init_SetSaturation(ISP_DEV IspDev, int Value);             // [0, 768]
ERRORTYPE AW_MPI_ISP_Init_SetSharpness(ISP_DEV IspDev, int Value);      // [1, 4095]
...
AW_S32 AW_MPI_ISP_AWB_SetMode(ISP_DEV IspDev, int Value);		// [0:auto, 1:manual, 2-9]
...
AW_S32 AW_MPI_ISP_SetBrightness(ISP_DEV IspDev, int Value); 		//[0, 512]
AW_S32 AW_MPI_ISP_SetContrast(ISP_DEV IspDev, int Value);   			// [0, 512]
AW_S32 AW_MPI_ISP_SetSaturation(ISP_DEV IspDev, int Value); 			// [0, 768]
AW_S32 AW_MPI_ISP_SetSharpness(ISP_DEV IspDev, int Value); 		// [1, 4095]
