...
typedef struct awVI_ATTR_S {
    ...
    unsigned char large_dma_merge_en; /* 0: dma not to merge, 1: 2in1 switch mode, 2: dma horizontal merge , 3: dma vertical merge */
    ...
    struct dma_merge_scaler_cfg mStitchModeSensorScalerCfg;
} VI_ATTR_S;
...
typedef struct IspEncppSharpConfig {
    struct encpp_dynamic_sharp_config stDynamicSharpCfg;
    struct encpp_static_sharp_config stStaticSharpCfg;
} IspEncppSharpConfig;
