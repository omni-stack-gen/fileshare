...
ERRORTYPE AW_MPI_VENC_SetH264NalRefIdcNoneZeroValue(VENC_CHN VeChn, unsigned char value);
...
ERRORTYPE AW_MPI_VENC_SetVbrOptParam(VENC_CHN VeChn, VencVbrOptParam *pVbrOptParam);
ERRORTYPE AW_MPI_VENC_GetVbrOptParam(VENC_CHN VeChn, VencVbrOptParam *pVbrOptParam);

ERRORTYPE AW_MPI_VENC_EnableIspVeLink(VENC_CHN VeChn, VENC_IspVeLinkAttr *pIspVeLinkAttr);
ERRORTYPE AW_MPI_VENC_GetRegionDetectLink(VENC_CHN VeChn, sRegionLinkParam *pRegionLinkParam);
ERRORTYPE AW_MPI_VENC_SetRegionDetectLink(VENC_CHN VeChn, sRegionLinkParam *pRegionLinkParam);

ERRORTYPE AW_MPI_VENC_ConfigSEI(VENC_CHN VeChn, const VENC_SEI_ATTR *pAttr);

ERRORTYPE AW_MPI_VENC_DropFrame(VENC_CHN VeChn, int nDropNum);
