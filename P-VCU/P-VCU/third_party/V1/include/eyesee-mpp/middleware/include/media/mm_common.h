...
typedef enum MPP_EVENT_TYPE {
    ...
    MPP_EVENT_LINKAGE_ISP2VE_PARAM_EXTRA, // VENC_Isp2VeExtraParam
    ...
    MPP_EVENT_NEED_NEXT_FD,  // int muxChn
    MPP_EVENT_RECORD_DONE,   // int muxChn
    MPP_EVENT_WRITE_DISK_ERROR, // int muxChn
