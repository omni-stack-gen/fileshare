...
#define AW_V459 0x1817
#define AW_V853 0x1886

#define AWCHIP AW_V853
//AWCHIP will be defined in mpp_config.mk.
#ifndef AWCHIP
    #define AWCHIP AW_V853
    #warning "app don't define AWCHIP, use default value: AW_V853"
#endif
    ...
    #define MPP_VER_PRIX "_MPP_V"
#elif (AWCHIP==AW_V459)
    #define CHIP_NAME    "AWV459"
    #define MPP_VER_PRIX "_MPP_V"
#elif (AWCHIP==AW_V853)
    #define CHIP_NAME    "AWV853"
    #define MPP_VER_PRIX "_MPP_V"
#else
