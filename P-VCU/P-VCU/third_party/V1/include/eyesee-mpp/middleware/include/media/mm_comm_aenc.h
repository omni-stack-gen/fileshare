...
typedef struct AENC_ATTR_S
{
    ...
    int mInBufSize; //input abs buffer size. 0:default 64KB
    int mOutBufCnt; //out encoded audio frame number. 0: default 16.

    //int enc_law;    // added for g726 encoding type,1:a-law;0:u-law;
}AENC_ATTR_S;
