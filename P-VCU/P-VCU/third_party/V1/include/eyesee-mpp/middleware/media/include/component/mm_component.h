...
typedef enum COMP_INDEXTYPE {
    ...
    COMP_IndexVendorVencH264NalRefIdcNonZeroValue, /**< reference: unsigned char* */
    ...
    COMP_IndexVendorVencVbrOptParam, /** reference: VencVbrOptParam */
    COMP_IndexVendorVencEnableIspVeLink, /** reference: VENC_IspVeLinkAttr     */
    COMP_IndexVendorVencRegionDetectLinkParam, /** reference: sRegionLinkParam */
    COMP_IndexVendorVencSEI, /** reference: VENC_SEI_ATTR*     */
    COMP_IndexVendorVencDropFrame, /** reference: int*     */
    ...
    COMP_IndexVendorAIIgnoreData,             /**< reference: AIIgnoreDataParam */
    COMP_IndexVendorAOStartThresholdTime,     /**< reference: int */
...
typedef enum COMP_EVENTTYPE
{
    ...
    COMP_EventInfo,
    COMP_EventRawdata,
    COMP_EventRecordDone,   /**< reference: int muxChn */

    COMP_EventNeedNextFd,   /**< reference: int muxChn */
    ...
    COMP_EventLinkageIsp2VeParam_Extra, // VENC_Isp2VeExtraParam
