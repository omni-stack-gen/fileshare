#ifndef _CHANGE_SPEED_H_
#define _CHANGE_SPEED_H_

/*
a new algorithm invented for the
...
#define SONIC_AMDF_FREQ 4000
	...
	/* Get the number of current input samples. */
	// 得到当前音频的输入sample数
	int sonicGetNumInputSamples(sonicStream stream);
