...
#define VIDIOC_VIN_ISP_RESET \
	_IOWR('V', BASE_VIDIOC_PRIVATE + 80, unsigned int)
...
#define VODIC_VIN_SET_SCALER_CFG \
	_IOWR('V', BASE_VIDIOC_PRIVATE + 84, struct v4l2_rect)
...
#define VIDIOC_VIN_SET_SCALER_RESOLUTION \
	_IOWR('V', BASE_VIDIOC_PRIVATE + 103, struct dma_merge_scaler_cfg)
