...
#elif defined(TINA_PLATFORM)
#define ISP_ERR(fmt, arg...)    ALOGE("[ISP_ERR]" fmt, ##arg)
#define ISP_WARN(fmt, arg...)   ALOGW("[ISP_WARN]" fmt, ##arg)
#define ISP_PRINT(fmt, arg...)  ALOGD("[ISP]" fmt, ##arg)
#define ISP_TEST(fmt, arg...)   ALOGD("[ISP_TEST]" fmt, ##arg)
#else
...
#define ISP_TEST(x, arg...) 	printf("[ISP_TEST]" x , ##arg)
#endif
...
#elif defined(TINA_PLATFORM)
    #define  FUNCTION_LOG do { ALOGD(""); } while(0)
#else
