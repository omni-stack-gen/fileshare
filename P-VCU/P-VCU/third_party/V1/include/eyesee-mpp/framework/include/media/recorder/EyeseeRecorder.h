...
private:
    ...
    */
    ...
    std::vector<MUX_CHN> mMuxChns;    //belong to mux group, match with mMuxChnAttrs, mSinkInfos
    ...
    int64_t mPauseVideoPts;
    int64_t mPauseVideoDuration; //unit:ms
 ...
 */
     ...
     */
    status_t reencodeIFrame(int VencId);
