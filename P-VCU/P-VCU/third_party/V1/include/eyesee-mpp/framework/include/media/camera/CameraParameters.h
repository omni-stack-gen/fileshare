...
//    ISP_SATURATION_S& getSaturationValue();
    ...
    void ChnIsp_SetScene(enum ae_table_mode value);
    void ChnIsp_SetColorEffect(enum colorfx value);
    void ChnIsp_SetSpecialScene(scene_mode_t value);
    ...
    //int ChnIsp_GetHue();
    enum ae_table_mode ChnIsp_GetScene();
    enum colorfx ChnIsp_GetColorEffect();
    scene_mode_t ChnIsp_GetSpecialScene();
...
//    ISP_SATURATION_S mSaturation;
    ...
    /**
      ILLEGAL_ISP_PARAM means use default value of every param, and we don't get these default values.
    */
    int mChnIspAe_Mode;
    int mChnIspAe_ExposureBias; //[1, 8]
    int mChnIspAe_Exposure;
    int mChnIspAe_Gain;
    int mChnIspAe_ISOSensitive; //[0~7]->[auto,100,200,400,800,1600,3200,6400]
    int mChnIspAe_Metering;
    int mChnIspAwb_Mode; //[0:auto, 1:manual], ref to AW_MPI_ISP_AWB_SetMode(). ref to v4l2_auto_n_preset_white_balance but not same.
    int mChnIspAwb_ColorTemp; //[2,9], ref to AW_MPI_ISP_AWB_SetColorTemp().  ref to v4l2_auto_n_preset_white_balance.
    ...
    //int mChnIsp_Hue;
    enum ae_table_mode mChnIsp_Scene;
    enum colorfx mChnIsp_ColorEffect;
    scene_mode_t mChnIsp_SpecialScene;
