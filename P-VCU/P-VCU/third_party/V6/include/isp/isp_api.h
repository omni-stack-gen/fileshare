...
*            0(正确)
*   Note:
*       调用完该接口后会延时至少一帧等待ISP流水完成
*/
FH_SINT32 API_ISP_PauseShadow(FH_UINT32 u32IspDevId);
/*
*   Name: API_ISP_Resume
*            恢复ISP对图像处理与输出
*
...
*       无
*/
FH_SINT32 API_ISP_RunWithPara(FH_UINT32 u32IspDevId, ISP_RUN_PARA_S* pstRunPara);
/*
...
/*
*   Name: API_ISP_Exit_TimeOut
*            ISP线程退出，清理状态，等待由用户指定的超时时间
*
*   Parameters:
*
*       [IN]  FH_UINT32 u32IspDevId
*            ISP的设备号
*
*       [IN]  FH_UINT32 u32TimeOut
*            应用层指定的超时时间，单位是us
*   Return:
*            0(正确)
*   Note:
*       如果实际等待时间短，isp硬件退出的时候很有可能处于忙的状态，此时或许会导致非预期的异常
*/
FH_SINT32 API_ISP_Exit_TimeOut(FH_UINT32 u32IspDevId, FH_UINT32 u32TimeOut);
...
*      无
*/
FH_UINT32 API_ISP_WaitIspSem(FH_UINT32 u32IspDevId, ISP_SEM_TYPE_E enSemType);
/*
...
/*
*   Name: API_ISP_SetStitchStatMode
*            设置拼接组的统计模式
*
*   Parameters:
*
...
*            拼接组的ID
*
*       [IN]  ISP_STITCH_STAT_SEL ispStat
*            传入类型为ISP_STITCH_STAT_SEL枚举中的值，详见枚举
*
*       [IN]  STITCH_STAT_MODE mode
*            传入类型为STITCH_STAT_MODE枚举中的值，详见枚举
*
*   Return:
*           0(成功)
*           非0(失败)
...
*       在API_ISP_Run()之前调用
*/
FH_SINT32 API_ISP_SetStitchStatMode(FH_UINT8 u8GrpId, ISP_STITCH_STAT_SEL ispStat, STITCH_STAT_MODE mode);
/*
*   Name: API_ISP_BypassStrategy
*            停止ISP效果调整
*
*   Parameters:
*
...
*
*   Note:
*        调用了该接口后，API_ISP_Run的调度依旧，但是不运行改变图像效果的所有代码
*/
FH_SINT32 API_ISP_BypassStrategy(FH_UINT32 u32IspDevId, FH_BOOL bBypass);
/*
...
*
*   Note:
*        1. 该接口支持ISP SYS掉电，但DDR不掉电之后的恢复ISP现场操作
*        2. 第二个参数暂时无用，为保留参数
*/
...
*        无
*/
FH_SINT32 API_ISP_GetAovWkMode(FH_UINT32 u32IspDevId, ISP_AOV_MODE_CFG_S* pstAvoCfg);
/*
*   Name: API_ISP_WaitIspIdle
*            等待AOV模式下isp idle
*
*   Parameters:
*
...
*        无
*/
FH_SINT32 API_ISP_WaitIspIdle(FH_UINT32 u32IspDevId);
/**SENSOR_CONTROL*/
...
FH_SINT32 API_ISP_SensorCommonIf(FH_UINT32 u32IspDevId, ISP_SNS_COMIF_S* pstComIf);
...
*/
FH_SINT32 API_ISP_SetAeInfo3(FH_UINT32 u32IspDevId, const ISP_AE_INFO_3 *pstAeInfo2);
/*
...
*/
FH_SINT32 API_ISP_GetAeInfo3(FH_UINT32 u32IspDevId, ISP_AE_INFO_3 *pstAeInfo2);
/*
...
/*
*   Name: API_ISP_SetSensorAwbGainEn
*            设置SensorWBGain使能
*
*   Parameters:
*
...
*            ISP的设备号
*
*       [IN] FH_BOOL bSnsWbGainEn
*            0:SensorWBGain使能; 1:SensorWBGain使能打开；
*
*
*   Return:
*           0(成功)
...
*       无
*/
FH_SINT32 API_ISP_SetSensorAwbGainEn(FH_UINT32 u32IspDevId, const FH_BOOL bSnsWbGainEn);
...
*            ISP的设备号
*
*       [IN] ISP_LUT_CFG *pstLutCfg
*            类型为ISP_LUT_CFG的结构体指针，详细成员变量请查看ISP_LUT_CFG结构体定义。
*
*   Return:
*            0(正确)
*            非0(失败，详见错误码)
...
*       无
*/
FH_SINT32 API_ISP_SetLutCfg(FH_UINT32 u32IspDevId, ISP_LUT_CFG *pstLutCfg);
/** LSC*/
/*
...
*            ISP的设备号
*
*       [IN] ISP_LSC_CFG_2 *pstLscCfg2
*            类型为ISP_LSC_CFG_2的结构体指针，详细成员变量请查看ISP_LSC_CFG_2结构体定义。
*
*   Return:
*            0(正确)
*            非0(失败，详见错误码)
...
*       无
*/
FH_SINT32 API_ISP_SetLscCfg2(FH_UINT32 u32IspDevId, ISP_LSC_CFG_2 *pstLscCfg2);
/** NR3D*/
/*
...
*            获取码流的超时时间
*
*       [OUT] FH_VIDEO_FRAME *stFrameInfo
*            类型为FH_VIDEO_FRAME的结构体指针，详细成员变量请查看FH_VIDEO_FRAME结构体定义。
*
*   Return:
*            0(正确)
*            非0(失败，详见错误码)
...
*       无
*/
FH_SINT32 API_ISP_GetNr3dStream(FH_UINT32 u32IspDevId, FH_UINT32 u32TimeOut, FH_VIDEO_FRAME *stFrameInfo);
/*
*   Name: API_ISP_ReleaseNr3dStream
*            释放获取到的NR3D数据
*
*   Parameters:
*
...
*       无
*/
FH_SINT32 API_ISP_ReleaseNr3dStream(FH_UINT32 u32IspDevId, FH_VIDEO_FRAME *stFrameInfo);
/*
*   Name: API_ISP_SendNr3dUsrData
*            发送数据给IPB处理
*
*   Parameters:
*
...
*            非0(失败，详见错误码)
*   Note:
*       1. 需要符合从NR3D处当前获取到的数据格式
*       2. 赋值结构体中的frm_raw.st_data.data.base可以更改默认的coef地址，需要切换成系统默认的将该值赋值成0
*/
FH_SINT32 API_ISP_SendNr3dUsrData(FH_UINT32 u32IspDevId, FH_VIDEO_FRAME *stFrameInfo);
/** NR2D*/
/*
...
/*
*   Name: API_ISP_SetDrcInitCfg
*            初始化DRC硬件寄存器，调用阶段是在API_ISP_RegisterIspInitCfgCallback中。
*
*   Parameters:
*
*       [IN]  FH_UINT32 u32IspDevId
*            ISP的设备号
*
*       [IN] const DRC_INIT_CFG *pstDrcInitCfg
*            类型为DRC_INIT_CFG的结构体指针，详细成员变量请查看DRC_INIT_CFG结构体定义。
*
*   Return:
*            0(正确)
*            非0(失败，详见错误码)
...
*       无
*/
FH_SINT32 API_ISP_SetDrcInitCfg(FH_UINT32 u32IspDevId, const DRC_INIT_CFG *pstDrcInitCfg);
/*
...
*            ISP的设备号，通过它选择配置不同的ISP
*
*       [IN] ISP_SRC_INFO_S_S* pstSrcInfoS
*            Rawec数据结构体指针，用于描述Rawec数据源属性
*
*   Return:
*           0(成功)
*           非0(失败，详见错误码)
...
*      无
*/
FH_SINT32 API_ISP_SendRawecInfo(FH_UINT32 u32IspDevId, ISP_SRC_INFO_S_S* pstSrcInfoS);
/*
*   Name: API_ISP_WaitRawecInfoOver
*            等待Rawec数据被ISP处理完毕
*
*   Parameters:
*
...
*            ISP的设备号，通过它选择配置不同的ISP
*
*       [IN] ISP_RAWEC_ADDR_S_S* pstRawecInfo
*       类型为ISP_RAWEC_ADDR_S_S的结构体指针，详细成员变量请查看ISP_RAWEC_ADDR_S_S结构体定义。
*
*   Return:
*           0(成功)
*           非0(失败，详见错误码)
...
*      无
*/
FH_SINT32 API_ISP_WaitRawecInfoOver(FH_UINT32 u32IspDevId, ISP_RAWEC_ADDR_S_S* pstRawecInfo);
/*
*   Name: API_ISP_VicapRegisterCallback
*            唤醒信号量注册进VICAP中断回调内
*
*   Parameters:
*       [IN]  FH_UINT32 u32IspDevId
*            ISP的设备号
*
*       [IN/OUT] ISP_VICAP_CALLBACK_INFO_S* pstCallbackInfo
*            获取中断回调的信息的结构体指针
*
*   Return:
*           0(成功)
...
*         该接口不能在linux环境下使用
*/
FH_SINT32 API_ISP_VicapRegisterCallback(FH_UINT32 u32IspDevId, ISP_VICAP_CALLBACK_INFO_S* pstCallbackInfo);
/*
...
*            ISP的设备号
*
*       [OUT] ISP_DBG_INFO_S* pstDbgInfo
*            类型为ISP_DBG_INFO_S的结构体指针，详细成员变量请查看ISP_DBG_INFO_S结构体定义。
*
*   Return:
*           0(成功)
*           非0(失败，详见错误码)
*
*   Note:
*       1. 获取到的数据是最新一帧的ISP数据，一帧之后会更新
*/
FH_SINT32 API_ISP_GetDebugInfo(FH_UINT32 u32IspDevId, ISP_DBG_INFO_S* pstDbgInfo);
