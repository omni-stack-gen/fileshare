...
#define FHT_OSD_TEXT_VCTBOLD        (1<<2) /*矢量字体加粗*/
...
#define FHT_OSD_LAYER_DISABLE_ROTATE  (1<<3) /*关闭旋转，可以省部分vmm内存*/

/*字符行块配置*/
typedef struct {
    FH_CHAR*  textInfo; /* 自定义字符内容，矢量字库时仅支持UTF-8编码 */
