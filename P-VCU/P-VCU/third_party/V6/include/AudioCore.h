...
void AudioCore_SetAecConfigFile(const char *filename);
void AudioCore_SetPlayVolume(int volume);
void AudioCore_SetRecordVolume(int volume);
void AudioCore_SetLoopbackVolume(int volume);
int  AudioCore_Control(int type, int id, int command, int value, void *arg);
void AINS_Control(int ai_ns, int spp_ns);
...
bool Audio_Player_SetVolume(int StreamID, int volume);
...
bool Audio_Recorder_SetMute(int StreamID, bool mute);
bool Audio_Recorder_SetAINS(int StreamID, bool enable);
bool Audio_Recorder_SetVolume(int StreamID, int volume);
