...
OPERATE_RET TUYA_IPC_call_app()
{
     ...
     *
    */
    return tuya_tmm_control_call("key_1","sp_dpsxj", TUYA_TMM_CONTROL_STREAM_TYPE_AV);
#else

    char snapfile[64] = "/mnt/V1/code/PLC_Door/demo_snapshot.jpg";
    //strncpy(snapfile, TuyaCallJpg, 64);
