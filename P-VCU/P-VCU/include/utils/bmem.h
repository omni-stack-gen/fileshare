...
#define bmalloc(size)                  malloc((size)) //bmem_malloc((size))
#define brealloc(p, size)              realloc((p), (size)) //bmem_realloc((p), (size))
#define bfree(p)                       free((p)) //bmem_free((p))
